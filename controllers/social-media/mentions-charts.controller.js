...
function buildSourceFilterString(source, topicId, isSpecialTopic = false) {
  ...
  if (topicId && (parseInt(topicId) === 2619 || parseInt(topicId) === 2639 || parseInt(topicId) === 2640 || parseInt(topicId) === 2647 || parseInt(topicId) === 2648 || parseInt(topicId) === 2649)) {
    ...
    return  'source:("Twitter" OR "Facebook" OR "Instagram")';
      ...
      return  'source:("Twitter" OR "LinkedIn" OR "Linkedin" OR "Web" OR "Facebook" OR "Instagram")';
    }
    else {
...
const mentionsChartController = {
  ...
  audienceMentionsAcrossMentionType: async (req, res) => {
    try {
      ...
      return  'AND source:("Twitter" OR "LinkedIn" OR "Linkedin" OR "Web" OR "Facebook" OR "Instagram" )';
    }
       else {
