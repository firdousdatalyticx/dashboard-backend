...
applyCountryLocationFilter(query,country)
  ...
  getSinglesDistribution:async (req, res) => {
    try {
      const {
        timeSlot,
        fromDate,
...
const buckets = aggResponse.aggregations.signals.buckets;

// Extract phrases (signals)
const phrases = buckets
