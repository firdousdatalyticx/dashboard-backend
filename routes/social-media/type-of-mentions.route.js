...
router.post("/",transformCategoryData,transformDataSource,mentionsChartController.typeofMentions)
router.get('/posts', transformCategoryData,transformDataSource, mentionsChartController.mentionsPost);
router.post('/top10', transformCategoryData,transformDataSource, mentionsChartController.typeofMentionsTo10);
